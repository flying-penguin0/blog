...
public enum ResultCode {
    ...
    NICKNAME_EXIST(4003, "昵称已存在"),
    USER_NOT_FOUND(4004, "用户不存在"),
    PASSWORD_ERROR(4005, "密码错误"),
    USER_DISABLED(4006, "用户已被禁用"),
    ARTICLE_NOT_FOUND(4007, "文章不存在"),
    COMMENT_NOT_FOUND(4008, "评论不存在"),
    CATEGORY_NOT_FOUND(4009, "分类不存在"),
    TAG_NOT_FOUND(4010, "标签不存在"),
    FILE_UPLOAD_ERROR(4011, "文件上传失败"),
    FILE_TYPE_ERROR(4012, "文件类型不支持"),
    FILE_SIZE_ERROR(4013, "文件大小超出限制"),
    CONTENT_AUDIT_FAILED(4014, "内容审核未通过"),
    CAPTCHA_ERROR(4015, "验证码错误或已过期"),
